...
#ADD SCORING AND HEALTH OF AN ENEMY
...
bulletSound = pygame.mixer.Sound('img assets/bullet.wav')
#hitSound = pygame.mixer.Sound('img assets/hit.wav')
...
def redrawWindowGame():
    ...
    win.blit(text, (970,10))#SCORE POSITION
