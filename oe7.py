...
#ADD bgmusic and sound effects *in my case I need to improve it*
...
#construction for the class player
    ...
    def hit(self):
        ...
        self.y= 600
        self.walk_counter = 0
        font1 = pygame.font.SysFont('Montserrat Subrayada', 100,True)
        text = font1.render('TRY AGAIN!',1, (0,0,0))
